...
import { useCreateEvent } from "@/hooks/api/useEvents.js";
...
export default function CreateEventForm() {
  ...
  return (
    <div className="container">
      {/* Header */}
      <div className="mb-8">
        <h2 className="text-text-primary">Create New Event</h2>
      ...
      >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <input
                type="datetime-local"
                name="endDateTime"
                min={formik.values.startDateTime || formatLocalDateTime()}
                onChange={formik.handleChange}
                onBlur={formik.handleBlur}
        ...
        <div className="pt-2">
          <button
            type="submit"
            className="w-full sm:w-auto px-8 py-3 bg-primary text-white text-small font-medium rounded-xl hover:bg-primary/90 active:scale-[0.98] transition-all duration-150 cursor-pointer"
          >
            Create Event
          </button>
        </div>
